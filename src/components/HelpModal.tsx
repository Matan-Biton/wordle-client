      ...
      <div className="info">
        ...
        <ul>
          ...
          <li className=" list-disc ml-12">
            After filling an attempt it would automatically send your guess and will color the letters accordingly
          </li>
        </ul>
        <h2 className=" font-semibold">Examples:</h2>
        <ul>
          <li className=" list-disc ml-12 after:[w-10]">
            Boxes colored <span className={colorMap.get("b")}>green</span> indicates on a letter in its correct spot
          </li>
          <li className=" list-disc ml-12">
            Boxes colored <span className={colorMap.get("c")}>yellow</span> indicates on a letter that exists in the
            answer in another spot
          </li>
          <li className=" list-disc ml-12">
            Boxes colored <span className={colorMap.get("m")}>gray</span> indicates on a letter that is not used int the
            answer OR has one or more uses with the right indications
          </li>
        </ul>
      </div>
      <button
